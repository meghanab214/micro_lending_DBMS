    ...
    <>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
        <section className="rounded-[2rem] border border-slate-800/80 bg-slate-950/70 p-6 shadow-glow">
          ...
          <h1 className="mt-3 text-3xl font-bold text-white text-display">loan credit details</h1>
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-800 bg-white/5 p-4 text-sm text-slate-300">
              <p className="mt-2">Select a loan to load its credit score and status.</p>
            </div>
          </div>
        </section>
        ...
        <aside className="space-y-4">
          ...
          <StatCard label="Credit score" value={formatNumber(loan?.credit_score || 0)} accent="emerald" />
